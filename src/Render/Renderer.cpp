...
void Renderer::blitDepthToScreen(int windowWidth, int windowHeight) {
    if (!mainFBO) return;
    
    // Blit depth buffer from mainFBO to default framebuffer
    // This allows subsequent rendering to use the scene's depth for proper occlusion
